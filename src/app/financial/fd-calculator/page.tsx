        ...
        <div className="w-full">
            <SidebarLayout>
                <div className="text-center mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900 dark:text-blue-400 mt-2">
                        Calculate Maturity Amount & Interest Earnings
                    </h2>
                    <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mt-3 max-w-3xl mx-auto">
