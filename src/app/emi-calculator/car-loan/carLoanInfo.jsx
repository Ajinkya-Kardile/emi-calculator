    ...
    return (
        <div className="w-full mx-auto m-4 p-6 bg-white dark:bg-gray-900 rounded-lg">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">What is a Car Loan EMI?</h2>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">How Does a Car Loan Work?</h2>
                <p className="text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">Car Loan EMI Calculation Formula</h2>
                <p className="text-gray-700 dark:text-gray-300 mb-2">The EMI for a car loan is calculated using this formula:</p>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">Factors Affecting Car Loan EMI</h2>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">Types of Car Loans</h2>
                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">How to Apply for a Car Loan?</h2>
                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">Documents Required for Car Loan Approval</h2>
                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
