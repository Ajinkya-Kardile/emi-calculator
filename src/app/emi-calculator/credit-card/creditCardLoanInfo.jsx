    ...
    return (
        <div className="w-full mx-auto mt-4 p-6 bg-white rounded-lg">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">What is a Credit Card EMI?</h2>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">How Does Credit Card EMI Work?</h2>
                <p className="text-gray-700">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">Credit Card EMI Calculation Formula</h2>
                <p className="text-gray-700 mb-2">The EMI for a credit card transaction is calculated using this
                    formula:</p>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">Factors Affecting Credit Card EMI</h2>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">Benefits of Credit Card EMI</h2>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">How to Convert Purchases into Credit Card
                    EMI?</h2>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">Why Use a Credit Card EMI Calculator?</h2>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
