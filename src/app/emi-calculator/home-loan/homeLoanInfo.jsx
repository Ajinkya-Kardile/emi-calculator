    ...
    return (
        <div className="w-full mx-auto m-4 p-6 bg-white dark:bg-gray-900 rounded-lg">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">What is a Home Loan
                    EMI?</h2>
                <p className="text-gray-700 dark:text-gray-300">
                    A <strong>Home Loan EMI (Equated Monthly Installment)</strong> is a fixed monthly payment made by a
                    borrower to repay the home loan.
                    It includes two components: <strong>Principal</strong> (loan amount)
                    and <strong>Interest</strong> (cost of borrowing).
                </p>
                <p className="text-gray-700 dark:text-gray-300 mt-3">
                    Use our <strong>Home Loan EMI Calculator</strong> to estimate your monthly payments instantly.
                    Simply enter your <strong>loan amount, interest rate, and tenure</strong> to calculate the EMI
                    accurately.
                </p>
            </section>

            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">How Does a Home Loan
                    Work?</h2>
                <p className="text-gray-700 dark:text-gray-300">
                    A home loan is a secured loan where the property itself serves as collateral.
                    The borrower repays the loan amount in EMIs over a predetermined tenure, typically ranging
                    from <strong>10 to 30 years</strong>.
                </p>
                <p className="text-gray-700 dark:text-gray-300 mt-3">
                    Lenders offer different interest rate types – <strong>fixed-rate</strong> (constant EMI)
                    and <strong>floating-rate</strong> (variable EMI based on market rates).
                </p>
            </section>

            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">Home Loan EMI Calculation
                    Formula</h2>
                <p className="text-gray-700 dark:text-gray-300 mb-2">The EMI for a home loan is calculated using this
                    formula:</p>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">Factors Affecting Home Loan
                    EMI</h2>
                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
                    ...
                    <li><strong>Credit Score</strong> – A high credit score can help you secure lower interest rates.
                    </li>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">Types of Home Loans</h2>
                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
                    ...
                    <li><strong>Balance Transfer Home Loan</strong> – Transfer an existing loan to a lender offering
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">How to Apply for a Home
                    Loan?</h2>
                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">Documents Required for Home
                    Loan Approval</h2>
                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
                    ...
                    <li><strong>Credit Score Report</strong> – Some lenders require a credit check before loan approval.
                    </li>
                </ul>
            </section>

            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 dark:text-blue-300 mb-3">Why Use a Home Loan EMI
                    Calculator?</h2>
                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
