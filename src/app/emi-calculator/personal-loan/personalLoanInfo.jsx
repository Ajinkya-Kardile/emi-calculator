    ...
    return (
        <div className="w-full mx-auto mt-4 p-6 bg-white rounded-lg">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">What is a Personal Loan EMI?</h2>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">How Does a Personal Loan Work?</h2>
                <p className="text-gray-700">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">Personal Loan EMI Calculation Formula</h2>
                <p className="text-gray-700 mb-2">The EMI for a personal loan is calculated using this formula:</p>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">Factors Affecting Personal Loan EMI</h2>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">How to Reduce Your Personal Loan EMI?</h2>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">Documents Required for a Personal Loan</h2>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-3">Why Use a Personal Loan EMI Calculator?</h2>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
