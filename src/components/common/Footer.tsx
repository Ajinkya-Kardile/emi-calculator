            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link href={footerData.brand.homeLink} className="flex items-center">
                            <img src={footerData.brand.logo} className="h-8 me-3" alt={`${footerData.brand.name} Logo`} />
                ...
                <div className="flex justify-center">
                    <span className="text-sm text-gray-500 dark:text-gray-400">
                        © {currentYear} <Link href={footerData.brand.homeLink} className="hover:underline">{footerData.brand.name}</Link>. All Rights Reserved.
                    </span>
                </div>
            </div>
        </footer>
